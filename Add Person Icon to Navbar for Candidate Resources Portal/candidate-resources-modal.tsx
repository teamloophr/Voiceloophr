...
export default function CandidateResourcesModal({ isOpen, onClose, isDarkMode }: CandidateResourcesModalProps) {
  ...
  const renderPlatformCard = (platform: any, type: string) => (
    <div
      key={platform.name}
      style={{
      ...
      >
        ...
        <div style={{
          ...
          <section style={{ marginBottom: '32px' }}>
            ...
            {openSourceATS.map(platform => renderPlatformCard(platform, 'ats'))}
          </section>
          ...
          <section style={{ marginBottom: '32px' }}>
            ...
            {freemiumPlatforms.map(platform => renderPlatformCard(platform, 'freemium'))}
          </section>
          ...
          <section style={{ marginBottom: '32px' }}>
            ...
            {sourcingPlatforms.map(platform => renderPlatformCard(platform, 'sourcing'))}
          </section>
